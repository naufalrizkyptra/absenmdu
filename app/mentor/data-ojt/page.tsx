...
export default function DataOJTPage() {
  ...
  return (
    <div className="min-h-screen bg-[#f4f7fe] flex flex-col md:flex-row font-sans">
      ...
      {/* SIDEBAR - Sekarang udah 100% sama persis kayak dashboard utama */}
      <aside className="w-64 bg-white border-r border-slate-100 hidden md:flex flex-col shadow-sm z-10">
        ...
        <div className="px-4 pb-4">
          ...
          <nav className="space-y-1.5">
            {/* Tombol Overview sekarang jadi abu-abu karena lagi di halaman Data */}
            <button 
            ...
            {/* Tombol Data OJT ini yang jadi nyala gelap */}
            <button 
      ...
      <main className="flex-1 p-8 overflow-auto">
        <div className="mb-8">
          <h1 className="text-2xl font-bold text-slate-800">Manajemen Anggota OJT</h1>
          <p className="text-sm text-slate-500">Kelola data, edit profil, atau hapus akun tim lu.</p>
        </div>

        {/* CONTAINER SEARCH & TOMBOL TAMBAH */}
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
          ...
          <div className="relative w-full sm:w-80">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2.5 rounded-xl border border-slate-200 bg-white text-slate-900 text-sm focus:outline-none focus:border-blue-600 focus:ring-1 focus:ring-blue-600 shadow-sm transition-all"
            />
          </div>
          <button 
            onClick={() => setShowAddModal(true)}
            className="w-full sm:w-auto bg-[#1e1b4b] hover:bg-blue-700 text-white font-bold py-2.5 px-5 rounded-xl transition-all shadow-md text-sm flex items-center justify-center gap-2"
          >
            {/* ICON PLUS SVG */}
